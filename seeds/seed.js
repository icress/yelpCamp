...
const { features, descriptors, cities, imageSeed} = require('./seedHelper');
...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const shuffledArr = imageSeed.sort(function(){return 0.5 - Math.random()});
        const imgs = shuffledArr.slice(0, 3)
